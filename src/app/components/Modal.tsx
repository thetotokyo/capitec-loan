...
export default function Modal({title, subtitle, onClose, color = 'text-green-600'}: ModalProps) {
  ...
  return (
    <div className="w-full h-screen bg-gray-500/60 p-5 left-0 bottom-0 fixed z-20 flex items-center justify-center">
        <div className="bg-white p-10 mt-10 rounded-2xl shadow-xl max-w-3xl text-center">
